...
<head>
    ...
    <!-- Bootstrap Core Css -->
    <link href="../in/accounts-duren/plugins/bootstrap/css/bootstrap.css" rel="stylesheet" />
    <!-- Waves Effect Css -->
    <link href="../in/accounts-duren/plugins/node-waves/waves.css" rel="stylesheet" />
    <!-- Animation Css -->
    <link href="../in/accounts-duren/plugins/animate-css/animate.css" rel="stylesheet" />
    <!-- Custom Css -->
    <link href="../in/accounts-duren/css/style.css?v=1.2.1" rel="stylesheet" />
    <!-- Themes. You can choose a theme from css/themes instead of get all themes -->
    <link href="../in/accounts-duren/css/themes/all-themes.css" rel="stylesheet" />
    <link href="../in/accounts-duren/css/modif-style.css?v=1.2.1" rel="stylesheet" />
    <link href="../in/accounts-duren/css/flexible.css?v=1.2.1" rel="stylesheet" />
...
<body class="bd-w">
                        ...
                        <li class="liListNone">
                            <ul class="ulHeader-liMenu-UserLogin">
                                <li class="liImageHeader-liMenu-UserLogin"> 
                                    <!-- <img width="60px" id="foto_OnLoginPageHome_Large" src="../in/accounts-duren/images/blank.jpg" class="lazy center-img-drp-dwProfileSmall"  /> -->
                                </li>
                ...
                <ul class="list" style="margin-top: 20px;padding-bottom: 40px;">
                    <li class="liListNone" id="userInfoLogin">
                        <ul class="ulLeft-liMenu-UserLogin">
                            <li class="liImageHeader-liMenu-UserLogin"> 
                                <!-- <img width="60px"  src="../in/accounts-duren/images/blank.jpg" id="foto_OnLoginPageHome_Small" class="lazy center-img-drp-dwProfileSmall"  /> -->
                            </li>
                    ...
                    <li class="active-menu-right" id="account-link">
                        <a id="waves-effect-this" >
                            <div class="icon-menu-img-left">
                                <img src="../in/accounts-duren/images/durian/user.svg" width="20" height="20">
                            </div>
                    ...
                    <li class="menu-waves-block" id="account-edit-link">
                        <a  id="waves-effect-this" >
                            <div class="icon-menu-img-left">
                                <img src="../in/accounts-duren/images/durian/edit-user.svg" width="20" height="20">
                            </div>
                    ...
                    <li class="menu-waves-block" id="password-link" >
                        <a id="waves-effect-this" >
                            <div class="icon-menu-img-left">
                                <img src="../in/accounts-duren/images/durian/password.svg" width="20" height="20">
                            </div>
                   ...
                   <!--  <li class="menu-waves-block" id="order-link">
                    ...
                    <li class="menu-waves-block" id="order-while-link">
                        <a  id="waves-effect-this">
                            <div class="icon-menu-img-left">
                                <img src="../in/accounts-duren/images/durian/link/buy.svg" width="20" height="20">
                            </div>
                    ...
                    <li class="menu-waves-block" id="history-link">
                        <a  id="waves-effect-this">
                            <div class="icon-menu-img-left">
                                <img src="../in/accounts-duren/images/durian/data-product.svg" width="20" height="20">
                            </div>
                    ...
                    <li class="menu-waves-block" id="home-link">
                        <a href="../" id="waves-effect-this">
                            <div class="icon-menu-img-left">
                                <img src="../in/accounts-duren/images/durian/company-edit.svg" width="20" height="20">
                            </div>
                    ...
                    <li class="menu-waves-block" id="logout-link">
                        <a href="../conn/logout.php" id="waves-effect-this">
                            <div class="icon-menu-img-left">
                                <img src="../in/accounts-duren/images/durian/logout.svg" width="20" height="20">
                            </div>
    ...
    <!-- Jquery Js -->
    <script type="text/javascript"  src="../in/accounts-duren/js/jquery.js" ></script>
    <!-- Jquery Ajax Js -->
    <script type="text/javascript" src="../in/accounts-duren/js/ajax/jquery.min.js" ></script>
    <!-- Jquery Core Js -->
    <script src="../in/accounts-duren/plugins/jquery/jquery.min.js"></script>
    <!-- Bootstrap Core Js -->
    <script src="../in/accounts-duren/plugins/bootstrap/js/bootstrap.js"></script>
    <!-- Select Plugin Js -->
    <script src="../in/accounts-duren/plugins/bootstrap-select/js/bootstrap-select.js"></script>
    <!-- Slimscroll Plugin Js -->
    <script src="../in/accounts-duren/plugins/jquery-slimscroll/jquery.slimscroll.js?v=1.1.1"></script>
    <!-- Waves Effect Plugin Js -->
    <script src="../in/accounts-duren/plugins/node-waves/waves.js"></script>
    <!-- Custom Js -->
    <script src="../in/accounts-duren/js/admin.js"></script>
    <!-- Demo Js -->
    <script src="../in/accounts-duren/js/demo.js"></script>
    <!-- Flash Js -->
    <script src="../in/accounts-duren/js/pages/konsumen/konsumenData.js?v=1.8.1"></script>
    <!-- Scrol -->
