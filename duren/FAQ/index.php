...
<body class="halamanUtama">
  ...
  <section id="testimoni">
    <div class="advantages-content">
      <div class="container">
        <div class="fotterCol row" id="">
          <div class="cardFAQ col-lg-12 col-md-12 col-sm-12">
            <div class="titleFAQ">FAQ</div>
            <div class="f-16" id="contentFAQ">
...
<script type="text/javascript" src="../js/faqData.js?v=1.1.1"></script>
