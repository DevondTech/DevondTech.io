<?php 
    ...
    if(isset($_GET['updataUserProfile'])){
        ...
        if($nama_lengkapUpdate!=''){
            ...
            $queryUpdateTBDataUser = "UPDATE tb_data_user SET id_jenis_kelamin='$id_jenis_kelaminUpdate', tanggal_lahir='$tanggal_lahirUpdate', alamat='$alamatUpdate', negara='$negaraUpdate', provinsi='$provinsiUpdate', kabupaten='$kabupatenUpdate', kota='$kotaUpdate', kecamatan='$kecamatanUpdate', kelurahan='$kelurahanUpdate', kode_pos='$kode_posUpdate' WHERE id_user = $id_user";
    ...
    if(isset($_GET['updataAlamatUserProfile'])){
        ...
        if($alamatUpdate!=''){
            $queryUpdateTBDataUser = "UPDATE tb_data_user SET alamat='$alamatUpdate', negara='$negaraUpdate', provinsi='$provinsiUpdate', kabupaten='$kabupatenUpdate', kota='$kotaUpdate', kecamatan='$kecamatanUpdate', kelurahan='$kelurahanUpdate', kode_pos='$kode_posUpdate' WHERE id_user = $id_user";
            $db->query($queryUpdateTBDataUser);
