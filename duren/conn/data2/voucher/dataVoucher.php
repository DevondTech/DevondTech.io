<?php
    if(isset($_GET['selectData'])){
        ...
        $query = "SELECT id_voucher, kode_voucher, jenis_voucher, waktu_berlaku, waktu_berlaku_detail, gambar_voucher, total_voucher FROM view_data_voucher where waktu_berlaku_detail >= '$now' ";
