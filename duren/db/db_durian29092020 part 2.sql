...
-- ----------------------------
-- Table structure for tb_data_user_copy1
-- ----------------------------
DROP TABLE IF EXISTS `tb_data_user_copy1`;
CREATE TABLE `tb_data_user_copy1`  (
  `id_data_user` int(100) NOT NULL AUTO_INCREMENT,
  `id_user` int(100) NULL DEFAULT NULL,
  `id_jenis_kelamin` int(100) NULL DEFAULT NULL,
  `tanggal_lahir` date NULL DEFAULT NULL,
...
-- ----------------------------
-- Records of tb_data_user_copy1
-- ----------------------------
INSERT INTO `tb_data_user_copy1` VALUES (1, 1, 1, '2018-06-22', 'jalan', 'in', 'ok', 'ok', 1, 'ok', 'oke', 'eko', '485798');
INSERT INTO `tb_data_user_copy1` VALUES (2, 2, 2, '2017-11-29', 'Jalan', 'Indonesia', 'Banten', 'Tangerang', 1, 'Tangerang Kota', NULL, NULL, '98868');
INSERT INTO `tb_data_user_copy1` VALUES (3, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tb_data_user_copy1` VALUES (4, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tb_data_user_copy1` VALUES (5, 5, 1, '1990-08-06', 'Jalan Ketapang 5 No 48', 'Indonesia', 'Jawa Barat', 'Depok', 3, 'Depok', NULL, NULL, '54673');
INSERT INTO `tb_data_user_copy1` VALUES (6, 6, 1, '2020-08-06', 'Jalan Jend. Sudirman Timur No 545', 'Indonesia', 'Jawa Barat', 'Bogor', 3, 'Depok', 'Sawangan', 'Kedaung', '43555');
INSERT INTO `tb_data_user_copy1` VALUES (7, 7, 2, '1990-03-09', 'depok', 'indonesia', 'jawa barat', 'depok', 3, 'depok', 'depok', 'kedaung', '61523');
INSERT INTO `tb_data_user_copy1` VALUES (8, 8, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO `tb_login_user` VALUES (1, '2020-08-04 16:52:03', 'a', 'Mohamad Eko', 'mohamad@gmail.com', '1', '../images/user/2020-08-281maxresdefault.jpg', '0bdc9d2d256b3ee9daae347be6f4dc835a467ffe', 1);
...
-- ----------------------------
INSERT INTO `tb_pemesanan` VALUES (1, 'DR01', '2020-08-09 15:34:22', 6, '', '', '', '', '', '', NULL, NULL, '', 1, 1, NULL, NULL, NULL, NULL, 2, NULL, NULL);
INSERT INTO `tb_pemesanan` VALUES (2, 'DR02', '2020-09-28 14:50:38', 7, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, 2, NULL, NULL);
...
-- ----------------------------
INSERT INTO `tb_produk` VALUES (1, 'Durian Montong ', 'Kini waktunya durian LOKAL jadi FENOMENAL!\r\n\r\nKing Fruit menghadirkan buah durian dengan jaminan kualitas rasa terbaik dari masa panen pilihan, dengan PREMIUM QUALITY tergambar dalam ketebalan daging, konsisten rasa yang LEGIT, MA', '', 1, 100, 1, 188000, 59000, 'gambar1_produk2020-09-281detail-bawor.png', 'gambar2_produk2020-09-281detail-bawor.png', 'gambar3_produk2020-09-281detail-bawor.png', 'gambar4_produk2020-09-281detail-bawor.png', NULL, 1);
...
(tb_produk.harga-tb_produk.diskon)*jumlah_pemesanan AS total_pembayaran,
tb_produk.gambar1_produk,
tb_pemesanan.jumlah_pemesanan,
tb_produk.id_satuan_produk,
rt_satuan_produk.satuan_produk,
