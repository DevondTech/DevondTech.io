...
<div>
    <div class="positionDataNull">
        <a  style="color:#2d472c;">
            <img src="../images/icon png/pembayaran-dikonfirmasi.png" class="imgDataNull">
            <div class="textClickToProduct">Pembayaran Anda Telah Dikonfirmasi, Barang Sedang Diproses</div>
        </a>
    </div>
</div>
