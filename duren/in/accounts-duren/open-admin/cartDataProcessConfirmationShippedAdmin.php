            ...
            <div id="" class="parrentDivTable" >
                <div class="scrollTableX">
                    <div class="marginLeft25">
                        <table style="width: 100%;" border=1px; class="table table-bordered" id="dataConfirmationShipped">
                            <thead>
                                <tr>
...
<script src="../js/pages/admin/cartDataShippedAdmin.js?v=1.2.1"></script>
</body>
</html>
