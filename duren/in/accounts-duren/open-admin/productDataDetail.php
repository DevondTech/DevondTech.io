        ...
        <div class="modal-content w100">
            ...
            <div class="modal-body" id="modal-body-pad"  >
                <form  method="post" action="" enctype="multipart/form-data" id="uploadGambar1Produk">
                    <input type="text" name="id_barangGambar1" id="id_barangGambar1" value="<?= $id_barang; ?>">
                    <div class="padding-card-textData">
                        ...
                        <div class="card-inputData">
                            <input  type="file" id="Gambar1Produk" name="Gambar1Produk" class="img-inputData" style="height:45px;" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" accept=".jpg,.png" >
                        </div>  
                    </div>
        ...
        <div class="modal-content w100">
            ...
            <div class="modal-body" id="modal-body-pad"  >
                <form  method="post" action="" enctype="multipart/form-data" id="uploadGambar2Produk">
                    <input type="hidden" name="id_barangPOSTGambar2" id="id_barangPOSTGambar2" value="<?= $id_barang; ?>">
                    <div class="padding-card-textData">
                        <div class="card-textData">
                            <div class="textData">
                                Gambar Produk 2
                        ...
                        <div class="card-inputData">
                            <input  type="file" id="Gambar2Produk" name="Gambar2Produk" class="img-inputData" style="height:45px;" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" accept=".jpg,.png" >
                        </div>  
                    </div>
        ...
        <div class="modal-content w100">
            ...
            <div class="modal-body" id="modal-body-pad"  >
                <form  method="post" action="" enctype="multipart/form-data" id="uploadGambar3Produk">
                    <input type="hidden" name="id_barangPOSTGambar3" id="id_barangPOSTGambar3" value="<?= $id_barang; ?>">
                    <div class="padding-card-textData">
                        <div class="card-textData">
                            <div class="textData">
                                Gambar Produk 3
                        ...
                        <div class="card-inputData">
                            <input  type="file" id="Gambar3Produk" name="Gambar3Produk" class="img-inputData" style="height:45px;" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" accept=".jpg,.png" >
                        </div>  
                    </div>
        ...
        <div class="modal-content w100">
            ...
            <div class="modal-body" id="modal-body-pad"  >
                <form  method="post" action="" enctype="multipart/form-data" id="uploadGambar4Produk">
                    <input type="hidden" name="id_barangPOSTGambar4" id="id_barangPOSTGambar4" value="<?= $id_barang; ?>">
                    <div class="padding-card-textData">
                        <div class="card-textData">
                            <div class="textData">
                                Gambar Produk 4
                        ...
                        <div class="card-inputData">
                            <input  type="file" id="Gambar4Produk" name="Gambar4Produk" class="img-inputData" style="height:45px;" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" accept=".jpg,.png" >
                        </div>  
                    </div>
