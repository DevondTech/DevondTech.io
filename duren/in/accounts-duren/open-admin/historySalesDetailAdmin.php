                    ...
                    <form method="POST" id="updateDataUser">
                        <div class="Card-inputDataUser-paddingTopBottom20px">
                            ...
                            <div class="card-inputDataUser-false">
                                <input type="text" name="kode_penjualan"  style="color: #737373" id="kode_penjualan" class="input-textDataUser-false" disabled>
                            </div>
                        </div>
                        <div class="Card-inputDataUser-paddingTopBottom20px">
                            <div class="card-textDataUser">
                            ...
                            <div class="card-inputDataUser-false">
                                <input type="text" name="waktu_penjualan" style="color: #737373" id="waktu_penjualan" class="input-textDataUser-false"  disabled>
                            </div>
                        </div>
                        <div class="Card-inputDataUser-paddingTopBottom20px">
                            <div class="card-textDataUser">
                        ...
                        <div class="Card-inputDataUser-paddingTopBottom20px">
                            ...
                            <div class="card-inputDataUser-false">
                                <input type="text" name="jumlah_penjualan" style="color: #737373" id="jumlah_penjualan" class="input-textDataUser-false"  disabled>
                            </div>
                        </div>
                        <div class="Card-inputDataUser-paddingTopBottom20px">
                            <div class="card-textDataUser">
                        ...
                        <div class="Card-inputDataUser-paddingTopBottom20px">
                            ...
                            <div class="card-inputDataUser-false">
                                <input type="text" name="total_penjualan" style="color: #737373" id="total_penjualan" class="input-textDataUser-false" disabled>
                            </div>
                        </div>
                        <div class="Card-inputDataUser-paddingTopBottom20px">
                            <div class="card-textDataUser">
...
<script src="../js/pages/admin/cartDataSalesDetailAdmin.js?v=1.2.1"></script>
</body>
