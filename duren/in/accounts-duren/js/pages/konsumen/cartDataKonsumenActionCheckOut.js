  ...
  $.ajax({
    ...
    success :  function(response)
    {
      if(response == "updateCheckOutByUserSuccess"){
        window.location.href = '../../../conn/data2/mail/sendCheckOut/index.php?email_send='+email_send+'&&kode_pemesanan_send='+kode_pemesanan_send+'&&produk_send='+produk_send+'&&jumlah_send='+jumlah_send+'&&waktu_pemesanan_send='+waktu_pemesanan_send+'&&total_harga_yang_harus_dibayar_send='+total_harga_yang_harus_dibayar_send;
      }
