    ...
    $.ajax({
        ...
        success: function(selectData) { 
            ...
            if(DataVoucher=='' || DataVoucher==null){
                ...
                var id_voucher_by_user_call_back = $('#id_voucher_by_user').val();
                console.log(id_voucher_by_user_call_back);
                var waktu_berlaku = DataVoucher[0].waktu_berlaku; 
                var id_voucher_by_user = DataVoucher[0].id_voucher_by_user; 
