        ...
        <div class="card">
            <div class="header">    
                <div class="row">                    
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7" id="card-title-content-home">
                        <div class="line-H">
                            <div class="text-black-title">Auto Token</div>
                            <div class="text-grey pad10top">Manage your Auto Token.</div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" id="body-title-content-home">
                        <div class="img-h-sm-ph">
                            <img width="100px" data-src="images/icon svg/auto-icon.svg"  src="images/blank.jpg" class="lazy center-img-home"   />
                        </div>
                    </div>  
                </div>
            </div>
        ...
        <div class="card">
            <div class="header">    
                <div class="row">                    
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7" id="card-title-content-home">
                        <div class="line-H">
                            <div class="text-black-title">Security</div>
                            <div class="text-grey pad10top">Security Checkup, provides personalized recommendations for securing your account.</div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" id="body-title-content-home">
                        <div class="img-h-sm-ph">
                            <img width="100px" data-src="images/icon svg/security-icon1.svg"  src="images/blank.jpg" class="lazy center-img-home"   />
                        </div>
                    </div>
                </div>
            </div>
