          ...
          <div  class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="divCardImage-large-detailProduct">
               <img data-src="../images/detail-bawor.png" src="../images/blank.png" id="largeRootIMGProduct" class="lazy image-center">
              </div>
              <div class="divCardImage-small-detailProduct">
                <div class="divImage-smallCenter-detailProduct">
                  <div class="image-small-detailProduct">
                    <img data-src="../images/detail-bawor.png" src="../images/blank.png" id="smallRootIMGProduct1" class="lazy image-smallCenter-detailProduct">
                  </div>
                  <div class="image-small-detailProduct">
                    <img data-src="../images/detail-bawor.png" src="../images/blank.png" id="smallRootIMGProduct2" class="lazy image-smallCenter-detailProduct">
                  </div>
                  <div class="image-small-detailProduct">
                    <img data-src="../images/detail-bawor.png" src="../images/blank.png" id="smallRootIMGProduct3" class="lazy image-smallCenter-detailProduct">
                  </div>
                  <div class="image-small-detailProduct">
                    <img data-src="../images/detail-bawor.png" src="../images/blank.png" id="smallRootIMGProduct4" class="lazy image-smallCenter-detailProduct">
                  </div>
                 <!--  <div class="image-small-detailProduct">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="margin-Bottom-detailProduct">
                <div class="textBlack25-boldLarge-detailProduct" id="RootJudulProduct">
              ...
              <br />
              <div class="margin-TopBottom-detailProduct">
                <div class="textBlack25-boldLarge-detailProduct" id="RootHargaProduct">
                  Rp. 0.000.000,-
                </div>
              </div>
              <div class="margin-TopBottom-detailProduct">
              ...
              <div class="margin-TopBottom20-detailProduct">
                <div class="textGrey16-regular-detailProduct" id="RootDetail1Product">
                  Lorem ipsum dolor sit amet consectectur elit ipsum dolor 
                </div>
                <div class="textGrey16-regular-detailProduct" id="RootDetail2Product">
                  Lorem ipsum dolor sit amet consectectur elit ipsum dolor sit amet consectectur elitipsum dolor sit amet consectectur elitipsum dolor sit amet consectectur elitipsum dolor sit amet 
                </div>
              </div>
            </div>
